 ...
 */
internal class SwitchTimelineAdapter :
    ListAdapter<TrackSwitchEvent, SwitchTimelineAdapter.ViewHolder>(DIFF) {

    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder =
        ViewHolder(SwitchTimelineItemView(parent.context))
    ...
    class ViewHolder(private val view: SwitchTimelineItemView) : RecyclerView.ViewHolder(view) {
