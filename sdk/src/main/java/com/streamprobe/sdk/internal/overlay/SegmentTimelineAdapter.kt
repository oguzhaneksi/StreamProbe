 ...
 */
internal class SegmentTimelineAdapter : ListAdapter<SegmentMetric, SegmentTimelineAdapter.ViewHolder>(DIFF) {
    override fun onCreateViewHolder(
        parent: ViewGroup,
        viewType: Int,
    ): ViewHolder = ViewHolder(SegmentTimelineItemView(parent.context))
    ...
    class ViewHolder(
        private val view: SegmentTimelineItemView,
    ...
    companion object {
        private val DIFF =
            object : DiffUtil.ItemCallback<SegmentMetric>() {
