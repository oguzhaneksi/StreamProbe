...
internal class RenditionListAdapter :
    ...
    private class RenditionItemViewHolder(val view: RenditionItemView) : RecyclerView.ViewHolder(view)
    private class RenditionSectionHeaderViewHolder(val view: RenditionSectionHeaderView) : RecyclerView.ViewHolder(view) {
    ...
    companion object {
        ...
        private val DIFF = object : DiffUtil.ItemCallback<RenditionListItem>() {
            ...
            override fun areContentsTheSame(old: RenditionListItem, new: RenditionListItem) =
                old == new
        }
    }
}
